...
public class SimpleFTP {
	 ...
	 * 
	 * Returns true if the file transfer was successful. The file is sent in
	 * passive mode to avoid NAT or firewall problems at the client end.
	 */
	 ...
	 */
	public synchronized boolean mkdir(String dirname) throws IOException {
	 ...
	 * 
	 * This is usually the default mode. Make sure you use binary mode if you
	 * are sending images or other binary data, as ASCII mode is likely to
	 * corrupt them.
	 */
